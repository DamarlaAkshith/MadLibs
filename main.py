...
Button(root, text= 'The Photographer', font ='arial 15', command= madlib1, bg = 'ghost white').pack()
Button(root, text= 'apple and apple', font ='arial 15', command = madlib3 , bg = 'ghost white').pack()
Button(root, text= 'The Butterfly', font ='arial 15', command = madlib2, bg = 'ghost white').pack()
